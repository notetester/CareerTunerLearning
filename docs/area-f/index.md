...
| 32 | 관심기반 게시글 추천 | `PersonalizedFeedService` | ✅ 구현됨 | 프로필·최근 반응 개인화 70% + 신선·인기 30% 혼합 |
...
- [관심기반 게시글 추천](/area-f/ai-post-recommend) — 프로필·최근 반응 7:3 혼합 피드 (#32).
...
1. **"AI 기능이 몇 개고 어디까지 됐나요?"** — 번호 기준 #29~#34 6개다. #30~#34는 운영 경로가 있고 #32는 프로필·최근 반응 7:3 혼합 피드다. #29만 전용 카드 파이프라인 없이 #31 부산물·런타임 요약으로 부분 대체된다.
